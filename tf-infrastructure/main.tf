...
module "atlantis" {
  source = "../tf-modules/terraform-aws-atlantis"
...
module "github_repository_webhook" {
  source = "../tf-modules/terraform-aws-atlantis/modules/github-repository-webhook"
...
module "atlantis_access_log_bucket" {
  source  = "../tf-modules/terraform-aws-s3-bucket"
